...
\setbeamertemplate{page number in head/foot}[totalframenumber] %add frame numbers in a very neat way
\usepackage{siunitx}
\usepackage{hyperref}
\usepackage{cancel}
\sisetup{
...
\subtitle{\begin{itemize}
        \item Depth Anything: Unleashing the Power of Large-Scale Unlabeled Data (V1)\footnote{ \scriptsize \textit{Lihe Yang, Bingyi Kang, Zilong Huang, Xiaogang Xu, Jiashi Feng, Hengshuang Zhao}; Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2024, pp. 10371-10381}
        \item Depth Anything V2 (V2)\footnote{\scriptsize \textit{Lihe Yang,Bingyi Kang Zilong Huang, Zhen Zhao, Xiaogang Xu, Jiashi Feng, Hengshuang Zhao}; arXiv, 2024, arxiv.org/abs/2406.09414 }
    \end{itemize}}
\author{Benjamin Stadler}
\institute{Tsinghua University; Class: Machine Vision (Fall 2024) \\
    Exchange Student from ETHZ; Contact: \texttt{\href{mailto:bestadle@ethz.ch}{bestadle@ethz.ch}}}
\date{October 2024}
